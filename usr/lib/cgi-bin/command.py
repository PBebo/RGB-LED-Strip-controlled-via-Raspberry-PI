...
print "<tr>"
if (actionname != "Stop"):
	print "<td><button class=\"Button\"><a href=\"..\\" + action + ".php?action=" + action + "&speed=" + speed + "&step=" + step + "&delay=" + delay + "&reverse=" + reverse + "&color1=" + color1 + "&color2=" + color2+ "&color3=" + color3+ "&color4=" + color4+ "&color5=" + color5+ "&color6=" + color6+ "\">Go Back</a></button></td>"
print "</tr>"
print "<tr>"
print "<td><button class=\"Button\"><a href=\"..\\index.php?" + action + ".php?action=" + action + "&speed=" + speed + "&step=" + step + "&delay=" + delay + "&reverse=" + reverse + "&color1=" + color1 + "&color2=" + color2+ "&color3=" + color3+ "&color4=" + color4+ "&color5=" + color5+ "&color6=" + color6+ "\">Main Menu</a></button></td>"
print "</tr>"
print "<tr>"
if (actionname != "Stop"):
	print "<td><button class=\"Button\"><a href=\"command.py?action=stop&&speed=" + speed + "&step=" + step + "&delay=" + delay + "&reverse=" + reverse + "&color1=" + color1 + "&color2=" + color2+ "&color3=" + color3+ "&color4=" + color4+ "&color5=" + color5+ "&color6=" + color6+ "\">Turn Off</a></button></td>"
print "</tr>"
print "</table"
print "</body>"
print "</html>"