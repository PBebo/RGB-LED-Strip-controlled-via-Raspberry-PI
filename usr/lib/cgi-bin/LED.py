...
def colorFade(color1, color2):
        for i in range(0, 3):
                ...
                # Initialise colorDone variable to know when a color fade is ove                                                                                                                                                             r
        ...
        while True:
                        ...
                        for i in range(0, 3):
                                if ops[colorOps[i]](execColor[i] + colorStep[i],                                                                                                                                                              colorList[color2][i]):
                                        ...
                                        colorDone[i] = True
                        # If the 3 fade are finish, set execColor[1] to colorLis                                                                                                                                                             t[2]
                        ...
                        if (colorDone[0] == colorDone[1] == colorDone[2] == True                                                                                                                                                             ):
                                ...
                                # Wait for a Delay before starting the next colo                                                                                                                                                             r fade
                                # if user wanted it
                                time.sleep(DELAY)
                        ...
                        for i in range(0, 3):
                                pwm(i,execColor[i])
                        print "rouge: ",execColor[0]," vert: ",execColor[1]," bl                                                                                                                                                             eu: ",execColor[2]
