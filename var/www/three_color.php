...
<body>
<FORM name="three_color" action="/cgi-bin/command.py" method="GET">
	<p><input type="text" name="action" value="three_color" style="display: none;"></p>
		<table>
			<tr>
				<td colspan="3"><p class="Title">Three color</p></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="3"><br /><p><button class="Button"><a href="three_color.php">Reset Color</a></button></p></td>
			</tr>
			<tr>
