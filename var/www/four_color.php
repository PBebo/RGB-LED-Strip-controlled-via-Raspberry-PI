...
<head>
    ...
    <title>Four Color</title>
    <script type="text/javascript" src="jscolor/jscolor.js"></script>
	<meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=false;">
</head>
<body>
<FORM name="four_color" action="/cgi-bin/command.py" method="GET">
	<p><input type="text" name="action" value="four_color" style="display: none;"></p>
		<table>
			<tr>
				<td colspan="3"><p class="Title">Four color</p></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="3"><br /><p><button class="Button"><a href="four_color.php">Reset Color</a></button></p></td>
			</tr>
			<tr>
