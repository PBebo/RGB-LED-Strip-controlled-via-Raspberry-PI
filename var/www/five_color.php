...
<head>
    ...
    <title>Five Color</title>
    <script type="text/javascript" src="jscolor/jscolor.js"></script>
	<meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=false;">
</head>
<body>
<FORM name="five_color" action="/cgi-bin/command.py" method="GET">
	<p><input type="text" name="action" value="five_color" style="display: none;"></p>
		<table>
			<tr>
				<td colspan="3"><p class="Title">Five color</p></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="3"><p><input class="color" type="text" name="color3" id="color3" maxlength="6" value="<?php echo $color3 ?>"></p></td>
			</tr>
			<tr>
				<td colspan="3"><p><input class="color" type="text" name="color4" id="color4" maxlength="6" value="<?php echo $color4 ?>"></p></td>
			</tr>
			<tr>
				<td colspan="3"><p><input class="color" type="text" name="color5" id="color5" maxlength="6" value="<?php echo $color5 ?>"></p></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="3"><br /><p><button class="Button"><a href="five_color.php">Reset Color</a></button></p></td>
			</tr>
			<tr>
