...
<FORM name="six_color" action="/cgi-bin/command.py" method="GET">
	<p><input type="text" name="action" value="six_color" style="display: none;"></p>
		<table>
			<tr>
				<td colspan="3"><p class="Title">Six color</p></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="3"><p><input class="color" type="text" name="color6" id="color6" maxlength="6" value="<?php echo $color6 ?>"></p></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="3"><br /><p><button class="Button"><a href="six_color.php">Reset Color</a></button></p></td>
			</tr>
			<tr>
